...
(moment as any).prototype.round = function (precision: number, key: RoundKey) {
  return round(this, precision, key);
};

(moment as any).prototype.ceil = function (precision: number, key: RoundKey) {
  return ceil(this, precision, key);
};

(moment as any).prototype.floor = function (precision: number, key: RoundKey) {
